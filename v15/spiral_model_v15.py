...
【量化指标评估层 (体检报告)】
  ...
  第三层 · 宏观结构对标 / Surrogate 对标 (模型对外部数据)
...
【运行】  python spiral_model_v15.py
【产物】  spiral_v15.png (15 面板物理图)
          spiral_v15_metrics.png (指标图)
          _v15_data.json (含 metrics 三层指标)
          _v15_hj_scan.png (F2a 负对照扫描)
