...
\textbf{tensor-network library constraint}: the MERA construction used \cite{EvenblyVidal2007} requires $L$
...
\medskip
\noindent\textbf{This does not make the readout meaningless.} In a MERA \cite{EvenblyVidal2014} the geometry
